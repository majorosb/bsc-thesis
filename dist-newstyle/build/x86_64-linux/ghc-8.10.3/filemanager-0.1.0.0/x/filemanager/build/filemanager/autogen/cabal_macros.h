...
/* package filemanager-0.1.0.0 */
#ifndef VERSION_filemanager
#define VERSION_filemanager "0.1.0.0"
#endif /* VERSION_filemanager */
#ifndef MIN_VERSION_filemanager
#define MIN_VERSION_filemanager(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_filemanager */
...
#define CURRENT_COMPONENT_ID "filemanager-0.1.0.0-inplace-filemanager"
